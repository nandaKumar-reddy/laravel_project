        ...
        const fetchTickets = async () => {
            ...
            try {
                const response = await fetch(
                    `http://127.0.0.1:8000/api/admin/request-tickets?page=${currentPage}&perPage=${perPage}&search=${searchTerm}`
                );
                if (!response.ok) {
                        ...
                        <table className="hidden sm:table min-w-full border-collapse bg-white shadow-md rounded-lg overflow-hidden">
                            <thead className="text-white bg-[#f8703c]">
                                <tr>
                                    ...
                                    <th className="px-6 border border-gray-300 py-3 text-center">
                                        Employee
                                    </th>
